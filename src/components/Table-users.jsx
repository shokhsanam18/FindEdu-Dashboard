          ...
          {loading ? (
            ...
            <>
              <table className="w-full table-auto text-left">
                <thead>
                  <tr>
                    <th className="border-b p-4 w-1/10">ID</th>
                    <th className="border-b p-4 w-1/10">Ism</th>
                    <th className="border-b p-4 w-1/10">Familiya</th>
                    <th className="border-b p-4 w-1/10">Email</th>
                    <th className="border-b p-4 w-1/10">Telefon</th>
                    <th className="border-b p-4 w-1/10">Rol</th>
                    <th className="border-b p-4 w-1/10">Ro'yxatdan o'tgan sana</th>
                    <th className="border-b p-4 w-1/10">Parol</th>
                    <th className="border-b p-4 w-1/10">Rasm</th>
                    <th className="border-b p-4 w-1/10 text-center">Bajarish</th>
                  </tr>
                </thead>
                <tbody>
                  {users.map((user) => (
                    <tr key={user.id}>
                      ...
                      <td className="border-b p-4 truncate max-w-[150px]">
                        {renderCellWithPopover(formatDate(user.createdAt))}
                      </td>
                      <td className="border-b p-4 truncate max-w-[150px]">
                        ******
                      </td>
